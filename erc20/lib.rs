...
mod erc20 {
    ...
    mod tests {
        ...
        fn new_works() {
            // Constructor works.
            let _erc20 = Erc20::new(String::from("TestToken"), String::from("TST"), 100);
        ...
        fn total_supply_works() {
            // Constructor works.
            let erc20 = Erc20::new(String::from("TestToken"), String::from("TST"),100);
            // Transfer event triggered during initial construction.
            let emitted_events = ink_env::test::recorded_events().collect::<Vec<_>>();
            assert_transfer_event(
                &emitted_events[0],
        ...
        fn name_works() {
            ...
            // Get the token total supply.
            assert_eq!(erc20.name(), String::from("TestToken"));
        }
        ...
        fn symbol_works() {
            ...
            // Get the token total supply.
            assert_eq!(erc20.symbol(), String::from("TST"));
        }
        ...
        fn transfer_works() {
            // Constructor works.
            let mut erc20 = Erc20::new(String::from("TestToken"), String::from("TST"), 100);
            // Transfer event triggered during initial construction.
            let accounts =
                ink_env::test::default_accounts::<ink_env::DefaultEnvironment>()
                    .expect("Cannot get accounts");
